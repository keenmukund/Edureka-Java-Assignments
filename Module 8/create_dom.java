...
public class create_dom {
	...
	public static void main(String[] args) {
		...
		Text t1 = doc.createTextNode("10001");
		Text t2 = doc.createTextNode("Subhadeep Dan");
		Text t3 = doc.createTextNode("Male");
		Text t4 = doc.createTextNode("50000");
		Text t5 = doc.createTextNode("Ranchi,Jharkhand");
